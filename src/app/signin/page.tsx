    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-semibold text-gray-900">Splitwise</h1>
          <p className="text-sm text-gray-500 mt-1">Split expenses with friends, simply.</p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          ...
          >
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50"
            >
          ...
          {callbackUrl && callbackUrl.startsWith("/join/") && (
            <p className="text-xs text-gray-400 text-center mt-3">Sign in to join the group you were invited to.</p>
          )}
        </div>
      </div>
    </div>
